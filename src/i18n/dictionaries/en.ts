...
const en: Dictionary = {
  ...
  news: {
    ...
    tabNews: "News",
    tabPosts: "Posts",
    postPlaceholder: "What's happening in the market?",
    postButton: "Post",
    postBlocked: "This post didn't pass the content check.",
    postCooldown: "Please wait a moment before posting again.",
